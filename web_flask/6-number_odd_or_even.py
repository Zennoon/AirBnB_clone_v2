...
Contains:
    Misc
    ====
    Script to initialize a flask application with 7 routes defined, listening
    on 0.0.0.0:5000
    ...
    number_odd_or_even - Route function for the '/number_odd_or_even/' url
"""
...
def number_even_or_odd(num):
    """
    Route function for urls matching '/number_odd_or_even/<num>' where num is
    a positive integer

    Args:
        num (int): path following '/number_odd_or_even/', converted to an int
    """
